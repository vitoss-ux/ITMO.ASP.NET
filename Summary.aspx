<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Summary.aspx.cs" Inherits="ASP.net_Labs.Summary" MasterPageFile="~/Site.master" %>
...
<asp:Content
    ...
    <table> 
        ...
        <tbody>
            <% var yesData = ASP.net_Labs.Models.ResponseRepository.GetRepository().GetAllResponses().Where(r => r.WillAttend.Value);
