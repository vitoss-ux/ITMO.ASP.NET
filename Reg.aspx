<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reg.aspx.cs" Inherits="ASP.net_Labs.Reg" MasterPageFile="~/Site.master" UnobtrusiveValidationMode="None"%>
...
<asp:Content
    ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
         ...
         <div> 
            <label>Ваше имя:</label>
             ...
             <asp:RequiredFieldValidator
                 ...
                 ForeColor="#FF3300">Не оставляйте поле пустым
             </asp:RequiredFieldValidator>
        </div> 
        <div> 
            ...
            <asp:RequiredFieldValidator
                ...
                ErrorMessage="Заполните поле почтового адреса"
                ForeColor="#FF3300">Не оставляйте поле пустым
            </asp:RequiredFieldValidator>
       ...
       <div> 
        ...
        <asp:TextBox
            ID="TextBoxTextAnnot" runat="server"
            Width="345px">
        </asp:TextBox> 
       </div>
       <div>  
       ...
       <div> 
         Введите аннотацию доклада: 
       <asp:TextBox
           ID="TextBoxTextAnnot2" runat="server" 
           Width="345px">
       </asp:TextBox> 
 </div>
        <div> 
